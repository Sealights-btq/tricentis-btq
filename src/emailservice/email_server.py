...
class EmailServer:
    def __init__(self):
        self.logger = getJSONLogger("EmailServer")

    def receive_email(self, email_data):
        # Simulate receiving an email by logging the received email data
        self.logger.info(f"Received email from {email_data['from']} to {email_data['to']}")
        return {"status_code": 200, "message": "Email received"}
